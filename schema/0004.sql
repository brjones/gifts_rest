...
--
-- Create model TranscriptHistory
--
CREATE TABLE "transcript_history" ("ensembl_species_history_id" bigint REFERENCES ensembl_gifts.ensembl_species_history (ensembl_species_history_id), "transcript_id" bigint REFERENCES ensembl_transcript (transcript_id), CONSTRAINT transcript_history_pkey PRIMARY KEY (ensembl_species_history_id, transcript_id));
--
...
--
CREATE TABLE "uniprot_entry" ("uniprot_id" bigserial NOT NULL PRIMARY KEY, "uniprot_acc" varchar(30) NULL, "uniprot_tax_id" bigint NULL, "userstamp" varchar(30) NULL, "timestamp" timestamp with time zone NULL, "sequence_version" smallint NULL, "upi" varchar(13) NULL, "md5" varchar(32) NULL, "canonical_uniprot_id" integer NULL, "ensembl_derived" boolean NULL);
--
-- Create model UniprotEntryType
--
CREATE TABLE "uniprot_entry_type" ("uniprot_entry_version_id" bigserial NOT NULL PRIMARY KEY, "userstamp" varchar(30) NULL, "timestamp" timestamp with time zone NULL, "entry_type" boolean NULL);
--
...
ALTER TABLE "uniprot_entry_history" ADD CONSTRAINT "uniprot_entry_histor_uniprot_entry_versio_b1a47f0a_fk_uniprot_e" FOREIGN KEY ("uniprot_entry_version_id_id") REFERENCES "uniprot_entry_type" ("uniprot_entry_version_id") DEFERRABLE INITIALLY DEFERRED;
COMMIT;

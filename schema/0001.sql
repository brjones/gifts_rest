...
--
CREATE TABLE "alignment" ("alignment_id" bigserial NOT NULL PRIMARY KEY, "score1" double precision NULL, "report" varchar(300) NULL, "is_current" boolean NULL, "score2" double precision NULL);
--
...
--
CREATE TABLE "ensembl_uniprot" ("mapping_id" bigserial NOT NULL PRIMARY KEY, "userstamp" varchar(30) NULL, "timestamp" timestamp with time zone NULL, "mapping_history_id" bigint NULL, "sp_ensembl_mapping_type" varchar(50) NULL);
--
...
--
-- Create model GeneName
--
CREATE TABLE "gene_name" ("gene_name_id" bigserial NOT NULL PRIMARY KEY, "gene_symbol" varchar(45) NULL, "gene_name_type_id" bigint NULL);
--
-- Create model Isoform
--
CREATE TABLE "isoform" ("isoform_id" bigserial NOT NULL PRIMARY KEY, "accession" varchar(30) NULL, "sequence" varchar(200) NULL, "uniparc_accession" varchar(30) NULL, "embl_acc" varchar(30) NULL);
--
...
--
-- Create model Uniprot
--
CREATE TABLE "uniprot" ("uniprot_id" bigserial NOT NULL PRIMARY KEY, "uniprot_acc" varchar(30) NULL, "protein_existence_id" bigint NULL, "species" varchar(30) NULL, "uniprot_tax_id" bigint NULL, "ensembl_derived" boolean NULL, "is_isoform" boolean NULL, "entry_type" varchar(30) NULL, "release_version" varchar(30) NULL, "userstamp" varchar(30) NULL, "timestamp" timestamp with time zone NULL, "entry_version" bigint NULL, "mapping_history_id" bigint NULL, "sequence_version" smallint NULL, "is_canonical" bigint NULL, "upi" varchar(13) NULL, "md5" varchar(32) NULL, "canonical_accession" varchar(30) NULL);
--
...
--
CREATE TABLE "uniprot_entry_history" ("uniprot_entry_version_id" bigserial NOT NULL PRIMARY KEY, "release_version" varchar(30) NOT NULL);
--
-- Create model UniprotEntryVersion
--
CREATE TABLE "uniprot_entry_version" ("uniprot_entry_version_id" bigserial NOT NULL PRIMARY KEY, "protein_existence_id" bigint NULL, "ensembl_derived" boolean NULL, "is_isoform" boolean NULL, "entry_type" varchar(30) NULL, "userstamp" varchar(30) NULL, "timestamp" timestamp with time zone NULL, "entry_version" bigint NULL, "is_canonical" bigint NULL, "canonical_accession" varchar(30) NULL, "uniprot_id" bigint NULL);
--
-- Create model UniprotUnmapped
--
CREATE TABLE "uniprot_unmapped" ("uniprot_id" bigserial NOT NULL PRIMARY KEY, "uniprot_acc" varchar(30) NULL, "protein_existence_id" bigint NULL, "species" varchar(30) NULL, "uniprot_tax_id" bigint NULL, "entry_type" varchar(30) NULL, "release_version" varchar(30) NULL, "userstamp" varchar(30) NULL, "timestamp" timestamp with time zone NULL, "entry_version" bigint NULL, "mapping_history_id" bigint NULL, "sequence_version" smallint NULL, "upi" varchar(13) NULL, "md5" varchar(32) NULL);
--
